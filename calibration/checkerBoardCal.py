#Part of file written by Chris Rillahan

#Created by Chris Rillahan
#Last Updated: 02/02/2015
#Written with Python 2.7.2, OpenCV 3.0.0 and NumPy 1.8.0

#This program calculates the distortion parameters of a camera from a video file.
...
def ImageCollect(filename, n_boards):
    ...
    if status == True:
        ...
        while current_frame < total_frames:
            ...
            k = cv2.waitKey(int(FrameDuration)) & 0xff #You can change the playback speed here
